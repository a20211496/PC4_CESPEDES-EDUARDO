...
sidebar.markdown("<h1 style='text-align: center;'>Gráficos realizados en el curso</h1>", unsafe_allow_html=True)
...
if grafico_seleccionado == 'Conteo de palabras':
    sidebar.markdown("<div style='text-align: justify; font-size: 20px;'>Un gráfico en donde el inicio era el final del trabajo</div>", unsafe_allow_html=True)
    sidebar.image("Conteo de palabras.png", caption='Conteo de palabras', width=500)
    pass
elif grafico_seleccionado == 'Goles Milan':
    sidebar.markdown("<div style='text-align: justify'>Gráfico en donde se eligió un equipo al azar para analizar</div>", unsafe_allow_html=True)
